  ...
  return (
    <div className='w-full'>
      <div className="flex flex-col md:flex-row items-center mb-4 mt-4">
                ...
                />
                <button className="bg-blue-600 ml-4 text-white px-4 py-2 rounded hover:bg-blue-700 focus:outline-none transition duration-200" onclick={sortProperties}>Sort</button>
      </div>
